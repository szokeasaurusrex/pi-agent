...
- **Plan-only request** (the user asks only for a plan): load `references/plan-only.md` and follow it.
- **Plan-and-implement request** (the user asks to both plan and execute in one go): load `references/plan-and-implement.md` and follow it.
